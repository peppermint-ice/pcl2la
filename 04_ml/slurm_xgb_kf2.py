...
if __name__ == '__main__':
    ...
    try:
        ...
        for i, (train_index, val_index) in enumerate(kf.split(X_train)):
            ...
            train_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_train_kf_xgb_fold_{i}_noyear.csv"
            ...
            val_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_val_kf_xgb_fold_{i}_noyear.csv"
        ...
        model_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_best_model_xgb_noyear.pkl"
        ...
        test_output_file = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_test_results_xgb_noyear.csv"
        ...
        kfold_output_file = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_kfold_results_xgb_noyear.csv"

...
if __name__ == '__main__':
    ...
    try:
        ...
        global_test_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_lasso_global_test_set_byyearreveresed.csv"
        ...
        for i, (train_index, val_index) in enumerate(kf.split(X_train)):
            ...
            random_search = RandomizedSearchCV(Lasso(), param_distributions=param_dist, n_iter=100,
                                               cv=5,
            ...
            train_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_train_kf_lasso_fold_{i}_byyearreveresed.csv"
            ...
            val_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_val_kf_lasso_fold_{i}_byyearreveresed.csv"
        ...
        model_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_best_model_lasso_byyearreveresed.pkl"
        ...
        test_output_file = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_test_results_lasso_byyearreveresed.csv"
        ...
        kfold_output_file = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_kfold_results_lasso_byyearreveresed.csv"

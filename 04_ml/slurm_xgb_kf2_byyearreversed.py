...
if __name__ == '__main__':
    ...
    try:
        ...
        global_test_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_xgb_global_test_set_byyearreveresed.csv"
        ...
        for i, (train_index, val_index) in enumerate(kf.split(X_train)):
            ...
            train_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_train_kf_xgb_fold_{i}_byyearreveresed.csv"
            ...
            val_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_val_kf_xgb_fold_{i}_byyearreveresed.csv"
        ...
        model_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_best_model_xgb_byyearreveresed.pkl"
        model_filepath = os.path.join(model_folder_path, model_filename)
        with open(model_filepath, 'wb') as f:
            pickle.dump(best_model, f)

        # Save the best model using XGBoost's JSON format
        json_model_filename = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_best_model_xgb_byyearreveresed.json"
        ...
        test_output_file = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_test_results_xgb_byyearreveresed.csv"
        ...
        kfold_output_file = f"{parameter_name}_{parameter_value}_{assessment_name}_{repaired}_{eliminated}_kfold_results_xgb_byyearreveresed.csv"
